<template>
    <div>
        <div class="mt-0 md:my-36 lg:my-48 mx-0 md:mx-64 lg:mx-128">
            <div class="glass-card vstack align-start space-48 w-full p-36 md:p-48 rounded-10 md:shadow md:shadow-2xl">
                <div class="text-48 title md:text-64" style="font-weight: 500;">Welcome Address</div>
                <div class="text-20 weight-400 text-justify" style="line-height: 1.2;">
                    Dear Sir/Madam,
                </div>
                <div class="text-20 weight-400 text-justify" style="line-height: 1.2;">
                    On behalf of the organising committee of the Dunman High Model ASEAN Plus Summit (DHAP) 2021, I sincerely invite your institution to DHAP 2021. DHAP is the flagship event of the International and Strategic Affairs Council (ISAC), held in conjunction with
                    the Humanities Department of Dunman High School, with a unique focus on ASEAN. Here, participants take on the roles of diplomatic leaders of ASEAN nations and international players while discussing pertinent regional and international
                    issues.
                </div>
                <div class="text-20 weight-400 text-justify" style="line-height: 1.2;">
                    This year, our theme for DHAP 2021 is “From Unity, Strength”. After decades of globalisation, the world appears to be fragmenting at an unprecedented rate, epitomised best by the return of protectionism and treaty withdrawals. Multilateralism is in crisis,
                    at a time where the need for international cooperation is more urgent than ever before. At this critical juncture, international unity is a beacon of hope that is capable of furthering diplomacy and encouraging global effort to tackle
                    the multifaceted issues of today. Only then can we find strength, both as a region and as a world, to overcome current and future challenges together. Ultimately, the robustness of a community greatly depends on the cohesiveness of its
                ...
                <div class="text-20 weight-400 text-justify" style="line-height: 1.2;">
                    ...
                    become future leaders of change.
                </div>
                <div class="text-20 weight-400 text-justify" style="line-height: 1.2;">
                ...
                <div class="text-20 weight-400 text-justify" style="line-height: 1.2;">
                    ...
                    at aseanplus.communications@dhs.sg.
                </div>
                <div class="text-20 weight-400 text-justify" style="line-height: 1.2;">
                ...
                <div class="text-20 weight-400 text-justify" style="line-height: 1.2;">
                    Yours sincerely,
                    <span>
                    <svg width="250px" height="250px" class="svg-fill" viewBox="0 0 640 362" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2; margin-top: -60px; margin-bottom: -65px;">
                    ...
                    <br> Lim Jia Xuan Valene
                    <br> Secretary-General
                    <br> International and Strategic Affairs Council (ISAC)
                    <br> Organiser of Dunman High ASEAN Plus Summit
                </div>
            </div>
        </div>
