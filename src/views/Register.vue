  ...
  align-items: center;">
                        <div class="glass-card card vstack w-full h-auto card-bg rounded-3 shadow shadow-md card-shadow p-28 align-start space-28">
                            ...
                            <div style="line-height: 1.4;">
                                Registration for local delegates is now open and will close on [insert date] 23:59 (GMT +08:00). Delegates should be between the age of 14 and 18. There is a registration fee of $8 per delegate. The fee covers a merchandise package, which will be delivered to delegates’ schools.
                            </div>
